...
export default class SuiteCadastro extends React.Component {
    constructor() {
        super()
    ...
    onClickSalvarSuiteButton() {
        const account = this.state
            SuiteService.salvarSuite(account.nome, account.descricao, account.capacidade, account.valorDiaria)
            .then((result) => {
            ...
            <div>
                ...
                <div className="Post--container col-md-5">
                    <div className="Post--header">
                        <h3><span>Cadastrar Suítes</span></h3>
                    </div>
