...
export default class OpcionalCadastro extends React.Component {
    constructor() {
        super()
        this.state = this.getInitialState(), {
            selectedContent: Selected.OPCIONAL
        }
    ...
    onClickSalvarOpcionalButton() {
        const account = this.state
            OpcionalService.salvarOpcional(account.nome, account.descricao, account.valor)
            .then((result) => {
                ...
                <div>
                    ...
                    <div className="Post--container col-md-5">
                        <div className="Post--header">
                            <h3><span>Cadastrar Opcionais</span></h3>
                        </div>
                    <div>
                        {this.renderSuccess()}
                        {this.renderError()}
